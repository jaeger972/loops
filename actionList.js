...
Action.PracticalMagic = new Action("Practical Magic", {
    ...
    skills: {
        Practical() {Math.floor(100 * getSkillBonus("Magic"))}
    },
    manaCost() {
...
Action.LearnAlchemy = new Action("Learn Alchemy", {
    ...
    skills: {
        Magic: 50,
        Alchemy() {Math.floor(50 * getSkillBonus("Magic"))}
    },
    canStart() {
...
Action.BrewPotions = new Action("Brew Potions", {
    ...
    skills: {
        Magic: 50,
        Alchemy() {Math.floor(25 * getSkillBonus("Magic"))}
    },
    canStart() {
...
Action.HeroesTrial = new TrialAction("Heroes Trial", 0, {
    ...
    skills: {
        Combat: 500,
        Pyromancy() {Math.floor(100 * getSkillBonus("Magic"))},
        Restoration() {Math.floor(100 * getSkillBonus("Magic"))}
    },
...
Action.Chronomancy = new Action("Chronomancy", {
    ...
    skills: {
        Chronomancy() {Math.floor(100 * getSkillBonus("Magic"))}
    },
    manaCost() {
...
Action.LoopingPotion = new Action("Looping Potion", {
    ...
    skills: {
        Alchemy() {Math.floor(100 * getSkillBonus("Magic"))}
    },
    canStart() {
...
Action.Spatiomancy = new Action("Spatiomancy", {
    ...
    affectedBy: ["Wizard College"],
    skills: {
        Spatiomancy() {Math.floor(100 * getSkillBonus("Magic"))}
    },
    manaCost() {
...
Action.RaiseZombie = new Action("Raise Zombie", {
    ...
    skills: {
        Dark() {Math.floor(100 * getSkillBonus("Magic"))}
    },
    canStart() {
...
Action.DarkSacrifice = new Action("Dark Sacrifice", {
    ...
    skills: {
        Commune() {Math.floor(100 * getSkillBonus("Magic"))}
    },
    canStart() {
        return resources.blood >= 1;
    },
...
Action.RescueSurvivors = new MultipartAction("Rescue Survivors", {
    ...
    skills: {
        Restoration() {Math.floor(25 * getSkillBonus("Magic"))}
    },
...
Action.OpenPortal = new Action("Open Portal", {
    ...
    skills: {
        Restoration() {Math.floor(2500 * getSkillBonus("Magic"))}
    },
    allowed() {
        return 1;
    },
...
Action.ThievesGuild = new MultipartAction("Thieves Guild", {
    ...
    skills: {
        Thievery: 50,
        Practical() {Math.floor(50 * getSkillBonus("Magic"))}
    },
...
Action.GodsTrial = new TrialAction("Gods Trial", 1, {
    ...
    skills: {
        Combat: 250,
        Pyromancy() {Math.floor(50 * getSkillBonus("Magic"))},
        Restoration() {Math.floor(50 * getSkillBonus("Magic"))}
    },
    loopStats: ["Dex", "Str", "Con", "Spd", "Per", "Cha", "Int", "Luck", "Soul"],
    affectedBy: ["Team"],
    floorScaling: 1.3,
