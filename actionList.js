...
Action.OpenRift = new Action("Open Rift", {
    ...
    skills: {
        Dark(){ Math.floor(1000 * getSkillBonus("Magic"))}
    },
    allowed() {
        return 1;
    },
...
Action.PracticalMagic = new Action("Practical Magic", {
    ...
    skills: {
        Practical() {return Math.floor(100 * getSkillBonus("Magic"))}
    },
    manaCost() {
...
Action.LearnAlchemy = new Action("Learn Alchemy", {
    ...
    skills: {
        Magic: 50,
        Alchemy() {return Math.floor(50 * getSkillBonus("Magic"))}
    },
    canStart() {
...
Action.BrewPotions = new Action("Brew Potions", {
    ...
    skills: {
        Magic: 50,
        Alchemy() {return Math.floor(25 * getSkillBonus("Magic"))}
    },
    canStart() {
...
Action.DarkMagic = new Action("Dark Magic", {
    ...
    skills: {
        Dark() {
            return Math.floor(100 * Math.pow(1.01, getBuffLevel("Ritual")) * Math.pow(1.01, getSkillLevel("Commune")) * getSkillBonus("Magic"));
        }
    },
    manaCost() {
...
Action.HeroesTrial = new TrialAction("Heroes Trial", 0, {
    ...
    skills: {
        Combat: 500,
        Pyromancy() {return Math.floor(100 * getSkillBonus("Magic"))},
        Restoration() {return Math.floor(100 * getSkillBonus("Magic"))}
    },
...
Action.Chronomancy = new Action("Chronomancy", {
    ...
    skills: {
        Chronomancy() {return Math.floor(100 * getSkillBonus("Magic"))}
    },
    manaCost() {
...
Action.LoopingPotion = new Action("Looping Potion", {
    ...
    skills: {
        Alchemy() {return Math.floor(100 * getSkillBonus("Magic"))}
    },
    canStart() {
...
Action.Spatiomancy = new Action("Spatiomancy", {
    ...
    affectedBy: ["Wizard College"],
    skills: {
        Spatiomancy() {return Math.floor(100 * getSkillBonus("Magic"))}
    },
    manaCost() {
...
Action.RaiseZombie = new Action("Raise Zombie", {
    ...
    skills: {
        Dark() {return Math.floor(100 * getSkillBonus("Magic"))}
    },
    canStart() {
...
Action.DarkSacrifice = new Action("Dark Sacrifice", {
    ...
    skills: {
        Commune() {return Math.floor(100 * getSkillBonus("Magic"))}
    },
    canStart() {
        return resources.blood >= 1;
    },
...
Action.RescueSurvivors = new MultipartAction("Rescue Survivors", {
    ...
    skills: {
        Restoration() {return Math.floor(25 * getSkillBonus("Magic"))}
    },
...
Action.OpenPortal = new Action("Open Portal", {
    ...
    skills: {
        Restoration() {return Math.floor(2500 * getSkillBonus("Magic"))}
    },
    allowed() {
        return 1;
    },
...
Action.ThievesGuild = new MultipartAction("Thieves Guild", {
    ...
    skills: {
        Thievery: 50,
        Practical() {return Math.floor(50 * getSkillBonus("Magic"))}
    },
...
Action.GodsTrial = new TrialAction("Gods Trial", 1, {
    ...
    skills: {
        Combat: 250,
        Pyromancy() {return Math.floor(50 * getSkillBonus("Magic"))},
        Restoration() {return Math.floor(50 * getSkillBonus("Magic"))}
    },
    loopStats: ["Dex", "Str", "Con", "Spd", "Per", "Cha", "Int", "Luck", "Soul"],
    affectedBy: ["Team"],
    floorScaling: 1.3,
